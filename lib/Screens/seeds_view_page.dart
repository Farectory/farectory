...
class SeedsViewPage extends StatefulWidget {
 String name;
  String price;
  String description;
  String imageURL;
  ...
  @override
  State<SeedsViewPage> createState() => _SeedsViewPageState();
}

class _SeedsViewPageState extends State<SeedsViewPage> {
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Quantity: ${widget.quantity} per pack',
